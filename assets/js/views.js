...
carrito: (carrito) => {
        ...
        // Agrupamos el carrito por ID de producto para mostrar una sola CARD por modelo [cite: 503, 516]
        const productosUnicos = [...new Map(carrito.map(item => [item.id, item])).values()];
        
        // Sumatoria total de todas las tallas y cantidades [cite: 510, 511]
            ...
            <div class="row">
                <div class="col-lg-8">
                    ${productosUnicos.map(p => {
                        // Filtramos todas las tallas que pertenecen a este modelo específico [cite: 359, 360]
                        ...
                        <div class="card mb-4 shadow-sm border-0 position-relative">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-9">
                                    <div class="card-body">
                                        <h5 class="fw-bold pe-5">${p.nombre}</h5>
                                        ...
                                        <div class="row g-2 align-items-end border p-3 rounded bg-white mb-3">
                                            ...
                                            <div class="col-3">
                                                ...
                                                <span id="stock-info-${p.id}" class="text-primary" style="font-size:0.6rem"></span>
                                            </div>
                                            <div class="col-5">
